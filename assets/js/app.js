 ...
 * @param {*} eventType Event Type e.g.: "click", "mouseover"
 * @param {*} callback Callback function
 */
const addEvntOnElements = (elements, eventType, callback)=>{
...
const curruntLocationBtn = document.querySelector("[data-current-location-btn]");
...
export const updateWeather = (lat, lon) => {
    ...
    if(window.location.hash === "#/current-location"){
        curruntLocationBtn.setAttribute("disabled", "");
    }
    else {
        curruntLocationBtn.removeAttribute("disabled");
    }
        ...
        fetchData(url.forecast(lat, lon), (forecast)=>{
            ...
            for(const [index, data] of forecastList.entries()){
                ...
                const {
                    ...
                    main: { temp },
                    weather,
                    wind: { deg: windDirection, speed: windSpeen },
                } = data;
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <p class="body-3">${parseInt(module.mps_to_kmh(windSpeen))} km/h</p>
                    </div>
                `;
